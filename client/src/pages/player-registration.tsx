...
export default function PlayerRegistration() {
  ...
  return (
    <>
     <SEO
      title="Join TennisConnect | User Registration"
      description="Create your TennisConnect user profile and connect with tennis partners across Australia."
      canonical="/player-registration"
      tags={[
        "tennis",
        "tennis player",
        "tennis registration",
