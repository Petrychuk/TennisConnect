  ...
  return (
    <Suspense fallback={<RouteFallback />}>
      <Switch>
        ...
        <Route path="/players" component={PartnersPage} />
        {/* Old URL - server/routes.ts already sends a real 301 for
            full-page loads/crawlers; this covers pure client-side SPA
            navigation to the old path while the app is already running. */}
        <Route path="/partners">
          <Redirect to="/players" />
        </Route>
