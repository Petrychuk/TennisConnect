        ...
        <div className="max-w-3xl mx-auto md:mx-0">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-200 mb-8 max-w-xl leading-relaxed">
              Присоединяйся к крупнейшему сообществу теннисистов. Находи спарринг-партнеров, профессиональных тренеров и корты рядом с тобой.
            </p>
